...
const Hojados = () => {
    return(
        ...
        <Text  color="white" as="h1" fontWeight="bold" marginBottom={{base:'1em', md:'0.3em', lg:'0.3em',xl:'0.3em', '2xl':'0.3em',}} width="10em"  textAlign={{base:'center', md:'center', lg:'start',xl:'start', '2xl':'start',}} marginLeft={{base:'0', md:'-2em', lg:'0',xl:'0', '2xl':'0',}} fontSize="4xl" >Sobre Mi</Text>

        <Text  color="white" width={{base:'19.5em', md:'32em', lg:'35em',xl:'35em', '2xl':'35em',}} textAlign="justify" marginBottom="2em" fontWeight="bold" marginLeft={{base:'1em', md:'-9em', lg:'0',xl:'0', '2xl':'0',}} >Mi nombre es Ulises Fossati, tengo 18 años, vivo en la ciudad de Bahia Blanca, provincia de Buenos Aires. Estoy estudiando en una universidad, pero, también estudio mucho por mi cuenta para poder tener mejores habilidades y ver nuevas tecnologías.</Text>

        <Text  color="white" width={{base:'19.5em', md:'32em', lg:'35.5em',xl:'35.5em', '2xl':'35.5em',}} marginLeft={{base:'1em', md:'-9em', lg:'0',xl:'0', '2xl':'0',}} textAlign="justify" fontWeight="bold" >Estoy haciendo la Diplomatura en Programación web en la Universidad Tecnológica Nacional. Le dedico varias horas diarias para poder ir mejorando mis técnicas y habilidades. Estoy muy entusiasmado, ya que es algo que me gusta y le pongo mucha dedicación para poder ir progresando.</Text>
