...
const Titulo = () => {
    return(
        ...
        <Text fontWeight="bolder"  fontSize={{base:'1.5rem', md:'1.5rem', lg:'1.5rem',xl:'1.5rem', '2xl':'1.5rem',}} marginTop="-2" color="white"  width={{base:'13em', md:'18em', lg:'30.5em',xl:'30.5em', '2xl':'30.5em',}}   textAlign={{base:'start', md:'start', lg:'end',xl:'end', '2xl':'end',}} marginRight={{base:'-1em', md:'0', lg:'0',xl:'0', '2xl':'0',}}>Desarrollador de Front-End y Diseñador de UI/UX</Text>
      <div className='wspp'>
