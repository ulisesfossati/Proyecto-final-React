...
const Titulo = () => {
    return(
        ...
        <Text fontWeight="bolder" fontSize="1.4rem" color="white" marginRight={{base:'0', md:'0', lg:'0',xl:'10em', '2xl':'0',}}  width="13em"  >Hola, soy</Text>
        <Text fontWeight="bolder"  fontSize="2.9rem" letterSpacing="1px" marginTop="-2" color="white" marginRight={{base:'0', md:'0', lg:'0',xl:'4.9em', '2xl':'0',}}   >Ulises Fossati</Text>
        <Text fontWeight="bolder"  fontSize={{base:'1.5rem', md:'1.5rem', lg:'1.5rem',xl:'1.5rem', '2xl':'1.5rem',}} marginTop="-2" color="white"  width={{base:'13em', md:'13em', lg:'30.5em',xl:'30.5em', '2xl':'30.5em',}}   textAlign={{base:'start', md:'start', lg:'end',xl:'end', '2xl':'end',}} marginRight={{base:'-1em', md:'-1em', lg:'0',xl:'9em', '2xl':'0',}} >Desarrollador de Front-End y Diseñador de UI/UX</Text>
